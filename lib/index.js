...
function Client(options) {
  ...
  this.request = function request(requestOptions, callback) {
    if (callback) {
  ...
  this.get = function get(url, data, callback) {
    return this.request({
      method: 'GET',
  ...
  this.post = function post(url, data, callback) {
    return this.request({
      method: 'POST',
      headers: this.headers,
      uri: helper.baseUrl + url,
  ...
  this.del = function del(url, data, callback) {
    return this.request({
      method: 'DELETE',
      headers: this.headers,
      uri: helper.baseUrl + url,
  ...
  this.put = function put(url, data, callback) {
    return this.request({
      method: 'PUT',
      headers: this.headers,
      uri: helper.baseUrl + url,
