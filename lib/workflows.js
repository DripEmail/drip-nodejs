...
module.exports = {
  ...
  fetchWorkflow: function (accountId, workflowId, callback) {
    request.get(
      {
        url: helper.baseUrl + accountId + "/workflows/" + workflowId,
        headers: this.headers
      },
      function (error, response, body) {
        callback(error, response, body);
  ...
  activateWorkflow: function (accountId, workflowId, callback) {
    request.post(
      {
        url: helper.baseUrl + accountId + "/workflows/" + workflowId + "/activate",
        headers: this.headers
      },
      function (error, response, body) {
        callback(error, response, body);
  ...
  pauseWorkflow: function (accountId, workflowId, callback) {
    request.post(
      {
        url: helper.baseUrl + accountId + "/workflows/" + workflowId + "/pause",
        headers: this.headers
      },
      function (error, response, body) {
        callback(error, response, body);
  ...
  startOnWorkflow: function (accountId, workflowId, payload, callback) {
    request.post(
      {
        url: helper.baseUrl + accountId + "/workflows/" + workflowId + "/subscribers",
        headers: this.headers,
        json: true,
        body: payload
      },
  ...
  removeFromWorkflow: function (accountId, workflowId, emailOrId, callback) {
    request.del(
      {
        url: helper.baseUrl + accountId + "/workflows/" + workflowId + "/subscribers/" + emailOrId,
        headers: this.headers
      },
      function (error, response, body) {
        callback(error, response, body);
