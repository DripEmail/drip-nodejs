...
module.exports = {
  ...
  fetchCampaign: function (accountId, campaignId, callback) {
    request.get(
      {
        url: helper.baseUrl + helper.campaignsUrl(accountId, campaignId),
        headers: this.headers
      },
      function (error, response, body) {
        callback(error, response, body);
  ...
  activateCampaign: function (accountId, campaignId, callback) {
    request.post(
      {
        url: helper.baseUrl + helper.campaignsUrl(accountId, campaignId) + "/activate",
        headers: this.headers
      },
      function (error, response, body) {
        callback(error, response, body);
  ...
  pauseCampaign: function (accountId, campaignId, callback) {
    request.post(
      {
        url: helper.baseUrl + helper.campaignsUrl(accountId, campaignId) + "/pause",
        headers: this.headers
      },
      function (error, response, body) {
        callback(error, response, body);
  ...
  listAllSubscribesToCampaign: function (accountId, campaignId, callback) {
    request.get(
      {
        url: helper.baseUrl + "/" + helper.campaignsUrl(accountId, campaignId) + "/subscribers",
        headers: this.headers
      },
      function (error, response, body) {
        callback(error, response, body);
