...
// const client = require('./index.js')({ token: API_TOKEN, accountId: 2360272 });
...
// client.fetchAccount(8123611).then(function (response) {
...
// client.fetchBroadcast(27771156).then((response) => {
//   // console.log(response.body);
// }).catch((error) => {
//   // console.log('There was an error', error);
// });
