module.exports = {
  ...
  createTrigger(workflowId, payload, callback) {
    return this.post(`v2/${this.accountId}/workflows/${workflowId}/triggers`, { payload }, callback);
  },
  /**
  ...
  updateTrigger(workflowId, workflowTriggerId, payload, callback) {
    return this.put(`v2/${this.accountId}/workflows/${workflowId}/triggers/${workflowTriggerId}`, { payload }, callback);
  }
};
