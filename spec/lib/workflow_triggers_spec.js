...
describe('Workflows with promise', () => {
  ...
  it('should create a workflow trigger', (done) => {
    ...
    expect(client.post).toHaveBeenCalledWith('v2/9999999/workflows/444555/triggers', { payload: { provider: 'some_app' } }, undefined);
  });
  ...
  it('should update a workflow trigger', (done) => {
    ...
    expect(client.put).toHaveBeenCalledWith('v2/9999999/workflows/444555/triggers/df1234', { payload: { provider: 'some_app' } }, undefined);
  });
});
